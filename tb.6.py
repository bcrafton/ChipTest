...
def scan_chain_write_32b(tgt, wain, wdin):
    scan = wdin + wain + tgt + [1]
    scan = [0] * (377 - len(scan)) + scan
    scan.reverse()
...
wain = int_to_bin(5, 32)
wdin = int_to_bin(0x01010101, 32)
scan_chain_write_32b(tgt, wain, wdin)

wain = int_to_bin(10, 32)
wdin = int_to_bin(0x07070707, 32)
scan_chain_write_32b(tgt, wain, wdin)
...
rain = int_to_bin(5, 32)
scan_chain_read_32b(tgt, rain)

rain = int_to_bin(10, 32)
scan_chain_read_32b(tgt, rain)
