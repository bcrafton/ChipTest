...
int main() {
  ...
  while (1) {
    ...
    if (args[0] == 0) {
      ...
      if      (args[1] == 0) dac->set_voltage("vdd",       args[2]);
      else if (args[1] == 1) dac->set_voltage("avdd_cim",  args[2]);
      else if (args[1] == 2) dac->set_voltage("avdd_sram", args[2]);
      else if (args[1] == 3) dac->set_voltage("avdd_bl",   args[2]);
      else if (args[1] == 4) dac->set_voltage("avdd_wl",   args[2]);
      else if (args[1] == 5) dac->set_voltage("vref",      args[2]);
      else if (args[1] == 6) dac->set_voltage("vb1",       args[2]);
      else if (args[1] == 7) dac->set_voltage("vb0",       args[2]);
      else if (args[1] == 8) dac->set_voltage("vbl",       args[2]);
      else if (args[1] == 9) dac->set_voltage("vb_dac",    args[2]);
