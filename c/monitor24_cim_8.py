...
def sample_cim(N1, N2, NWL, bit, mux):
    ...
    for n1 in range(N1):
        ...
        for n2 in range(N2):
            ...
            vals = [ mix(0xa, WL, WLB, bit, mux) for _ in range(3) ]
            measured.append(np.median(vals))

            # val = mix(0xa, WL, WLB, bit, mux)
            # measured.append(val)
...
'''
1.0 0 (700, 525, 275, 450, 50)
1.0 1 (700, 525, 300, 450, 50)
1.0 2 (700, 525, 325, 450, 50)
1.0 3 (700, 550, 275, 450, 50)
1.0 4 (700, 550, 300, 450, 50)
1.0 5 (700, 550, 325, 450, 50)
1.0 6 (700, 575, 275, 450, 50)
1.0 7 (700, 575, 300, 450, 50)
1.0 8 (700, 575, 325, 450, 50)
'''
    ...
    for vbl in [300]:
      for vb1 in [450]:
        for vb0 in [50]:
          ...
          results[(avdd_cim, avdd_wl, vbl, vb1, vb0)] = sample_cim(100, 100, 8, bit, mux)
          np.save('results', results)
