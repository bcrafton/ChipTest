...
data_550 = process(np.loadtxt( fname='data_550.txt', dtype=np.uint32, delimiter=',' ))
data_575 = process(np.loadtxt( fname='data_575.txt', dtype=np.uint32, delimiter=',' ))
data_600 = process(np.loadtxt( fname='data_600.txt', dtype=np.uint32, delimiter=',' ))

datas = [data_500, data_525, data_550, data_575, data_600]
colors = ['red', 'blue', 'green', 'silver', 'black']
labels = ['500', '525', '550', '575', '600']
